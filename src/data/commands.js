...
export const fileSystem = {
  ...
  "socials": "GitHub: https://github.com/weeeol\nLinkedIn: https://www.linkedin.com/in/veolstevejose\nEmail: your.email@example.com\n\n(Tip: Type 'github' or 'linkedin' to open them directly!)",
  "fetch": `
      \\  /       OS: Veol-OS v1.0.0
       \\/        Host: Veol Steve
      /  \\       Kernel: GameDev-Core
     /____\\      Uptime: 42 days, 13 hours
                 Shell: veol-sh
  [Veol Steve]   Packages: 404 (npm)
                 Resolution: WebGL Native
                 Memory: 640K OS
  `,
  "neofetch": `
      \\  /       OS: Veol-OS v1.0.0
